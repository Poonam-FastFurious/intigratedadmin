  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `${Baseurl}finance/${id ? `update/${id}` : "add"}`,
        {
      ...
      >
        ...
        <div>
          ...
          >
            ...
            <option value="Annual Report subsidiaries">
...
export default AddFinanceDocument;
