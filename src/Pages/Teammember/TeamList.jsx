    ...
    <div className="body-content px-8 py-8 bg-slate-100">
      <div className="flex justify-between mb-10">
        <div className="page-title">
          <h3 className="text-2xl font-semibold">Team Members & Board</h3>
          <p className="text-gray-600 text-md">
            Manage all Team and Board of Directors
          </p>
        </div>
      </div>
            ...
            <table className="w-full text-base text-left text-gray-500">
              <thead className="bg-white">
                <tr className="border-b border-gray6 text-tiny">
                  ...
                  <th className="px-3 py-3 font-semibold uppercase">
                    Designation
                  </th>
              ...
              <tbody>
                {members.map((member) => (
                  <tr key={member._id} className="border-b border-gray6">
                    ...
                    <td className="px-3 py-3">{member.category}</td>
